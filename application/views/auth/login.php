            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        <form class="md-float-material form-material" action="<?php echo base_url().'login/authenticate'?>" name="loginForm" id="loginForm" method="post">
                        <fieldset>
                        
                            <div class="text-center">
                                <h2 style="color:white;">BILLING  MANAGEMENT SYSTEM</h2>
