                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5></h5><a href="#" data-toggle="modal" data-target="#exampleModal" class="btn btn-primary btn-sm">Add Category</a>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td><a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal<?=$i;?>"><i class="ti-pencil-alt"></i></a>
                                                                    <a href="<?=base_url('category-master/delete/'.$category->id);?>" class="btn btn-danger btn-sm"><i class="ti-trash"></i></a></td>
                                                            </tr>
                                            <!-- Modal -->
                                            ...
                                            <div class="modal-dialog  modal-dialog-centered modal-lg">
                                                <div class="modal-content">
                                                    <form class="form reload-page ajaxsubmit validate-form reload-tb" action="<?=base_url('category-master/save/'.$category->id)?>" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="modal-body">
                                                  <div class="row">
                                                    ...
                                                    <div class="col-12 form-group">
                                                        ...
                                                        <input type="text" placeholder="Enter Category name" name="category" class="form-control" value="<?=@$category->name;?>" required>
                                                    </div>
                                                  </div>
                                                </div>
...
<div class="modal fade empdoc" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content ">
            <form class="form ajaxsubmit reload-page validate-form reload-tb" action="<?=base_url('category-master/save')?>" method="POST" enctype="multipart/form-data">
                <div class="modal-header">
