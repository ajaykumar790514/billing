                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form class="form ajaxsubmit reload-page validate-form reload-tb" action="<?=base_url('')?>" method="POST" enctype="multipart/form-data">
                                                            <div class="row">
                                                                <div class="col-lg-4">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <input type="date" class="form-control" name="sup_name" placeholder="Expense Item" required>
