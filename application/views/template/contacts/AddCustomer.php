                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Add New Customer</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form class="form ajaxsubmit reload-page validate-form reload-tb" action="<?=base_url('customer/save')?>" method="POST" enctype="multipart/form-data">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label">Mobile No. <span class="text-danger">*</span></label>
                                                                        <div class="col-sm-9">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label">Credit Number</label>
                                                                        <div class="col-sm-9">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                        <input type="number" class="form-control" name="previous_due">
                                                                        </div>
                                                                    </div>    
                                                                </div>
                                                                <div class="col-lg-12">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="add_country" required>
                                                                        </div>
                                                                    </div>   
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="add_state" required>
                                                                        </div>
                                                                    </div>    
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="add_city" required>
                                                                        </div>
                                                                    </div>   
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                        <input type="number" class="form-control" name="add_pincode" required>
                                                                        </div>
                                                                    </div>    
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="add_address" required>
                                                                        </div>
                                                                    </div>   
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label">Lankmark <span class="text-danger">*</span></label>
                                                                        <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="add_landmark" required>
                                                                        </div>
                                                                    </div>    
                                                                </div>
                                                                <div class="col-lg-12">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                        <input type="number" class="form-control" name="ship_pincode">
                                                                        </div>
                                                                    </div>    
                                                                </div>
                                                                <div class="col-lg-6">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="ship_landmark">
                                                                        </div>
                                                                    </div>    
                                                                </div>
                                                            </div>
